...
<configuration  scan="true" scanPeriod="10 seconds">
    ...
    <!-- name的值是变量的名称，value的值为保存文件路径。通过定义的值会被插入到logger上下文中。定义后，可以使“${}”来使用变量。XML文件中配置 -->
    <property name="log.path" value="${catalina.base}/eureka_service_consumer_feign_cluster/logs"/>
